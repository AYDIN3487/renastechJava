...
public class Dublicate {
    ...
    public static void main(String[] args) {
        ...
        for (String each : letters2){
            ...
            int count2= Collections.frequency(letters2,each);
            System.out.println(each +" count is " + count2);

            if (count2 >1 && !dublicateLetters2.contains(each)){
                dublicateLetters2.add(each);
